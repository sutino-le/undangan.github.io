...
<head>
    ...
    <link href="<?= base_url() ?>/undangan/css/bootstrap.min.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="<?= base_url() ?>/undangan/js/fancybox/jquery.fancybox.css" type="text/css" media="screen" />
    <link href="<?= base_url() ?>/undangan/css/style.css" rel="stylesheet" type="text/css">
    <link href="<?= base_url() ?>/undangan/css/font-awesome.css" rel="stylesheet" type="text/css">
    <link href="<?= base_url() ?>/undangan/css/animate.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>/undangan/css/component.css" />
    <link href='http://fonts.googleapis.com/css?family=Raleway:200,400,800|Clicker+Script' rel='stylesheet' type='text/css'>

    <!--[if lt IE 9]>
    <script src="<?= base_url() ?>/undangan/js/respond-1.1.0.min.js"></script>
    <script src="<?= base_url() ?>/undangan/js/html5shiv.js"></script>
    <script src="<?= base_url() ?>/undangan/js/html5element.js"></script>
<![endif]-->
...
<body>
        ...
        <div class="content">
            <div id="large-header" class="large-header">
                ...
                <div class="main-title">
                    <h1 style="font-size: 48px;"><span>The Wedding</span></h1>
                    <div class="top_left_cont zoomIn wow animated">
                        <h2 style='color:white; text-shadow: 2px 2px 10px rgb(248, 77, 171);'><strong>Lela & Tino</strong></h2>
                        <h3 style='color:white; text-shadow: 2px 2px 10px rgb(248, 77, 171);'>26 Juni 2022, di Purbalingga</h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                <nav class="navbar navbar-inverse" role="navigation">
                    ...
                    <div id="main-nav" class="collapse navbar-collapse navStyle">
                        <ul class="nav navbar-nav" id="mainNav">
                            <li class="active"><a href="#intros" class="scroll-link">Home</a></li>
            ...
            <div class="container">
                ...
                <div class="inner_section">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h3>Bride’s story</h3>
                            <p>Lorem ipsum dolor sit amet, quo meis voluptaria, erant bonorum albucius et per, ei placerat eu, te eos
                                porro veniam. An everti maiorum detracto mea. Eu eos dicam voluptaria, erant bonorum albucius et per, ei
                                sapientem accommodare est. Saepe dolorum constituam ei vel. Te sit malorum ceteros repudiandae, ne
                                tritani adipisci vis.</p>
                            <h4>Hobbies </h4>
    ...
    <section id="service">
        <div class="container">
            ...
            <div class="service_wrapper">
                <div class="row">
                    <div class="col-md-3">
                        <div class="service_icon delay-03s animated wow  zoomIn"> <span><i class="fa fa-bitbucket"></i></span>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="service_icon icon3  delay-03s animated wow zoomIn"> <span><i class="fa fa-apple"></i></span>
                        </div>
                        <div class="service_block">
                    ...
                    <div class="col-md-3">
                        <div class="service_icon icon3  delay-03s animated wow zoomIn"> <span><i class="fa fa-heart"></i></span>
                        </div>
                        <div class="service_block">
    ...
    <section id="Portfolio" class="content">
        ...
        <div class="portfolio">
            ...
            <!-- Portfolio Wrapper -->
            <div class="isotope animated wow grid" style="position: relative; overflow: hidden; height: 480px;" id="portfolio_wrapper">
                <!-- Portfolio Item -->
    ...
    <footer class="footer_wrapper" id="contact">
        ...
        <div class="container">
            <div class="footer_bottom"><span>Copyright © 2018, Template by <a href="http://webthemez.com/wedding/">WebThemez.com</a>. </span> </div>
        </div>
    </footer>

    <script type="text/javascript" src="<?= base_url() ?>/undangan/js/jquery-1.11.0.min.js"></script>
    <script type="text/javascript" src="<?= base_url() ?>/undangan/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="<?= base_url() ?>/undangan/js/jquery-scrolltofixed.js"></script>
    <script type="text/javascript" src="<?= base_url() ?>/undangan/js/jquery.nav.js"></script>
    <script type="text/javascript" src="<?= base_url() ?>/undangan/js/jquery.easing.1.3.js"></script>
    <script type="text/javascript" src="<?= base_url() ?>/undangan/js/jquery.isotope.js"></script>
    <script src="<?= base_url() ?>/undangan/js/fancybox/jquery.fancybox.pack.js" type="text/javascript"></script>
    <script type="text/javascript" src="<?= base_url() ?>/undangan/js/wow.js"></script>
    <script src="contact/jqBootstrapValidation.js"></script>
    <script src="<?= base_url() ?>/undangan/js/rAF.js"></script>
    <script src="<?= base_url() ?>/undangan/js/demo-2.js"></script>
    <script src="contact/contact_me.js"></script>
    <script type="text/javascript" src="<?= base_url() ?>/undangan/js/custom.js"></script>
